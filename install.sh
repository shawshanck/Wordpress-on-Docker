...
volumes:
  ...
  phpmyadmin:" > docker-compose.yml
	...
	echo -e "${MAGENTA}      3.${NC}${GREEN} Installation Completed. Details are:${NC}"
        ...
        echo -e ""
        echo -e "${NC}     Database Username: ${GREEN}${dusr:-"exampleuser"}${NC}"
        echo -e "${NC}     Database Password: ${GREEN}${dpss:-"examplepass"}${NC}"
        echo -e "${NC}     Database Name: ${GREEN}${dbnm:-"exampledb"}${NC}"
        echo -e ""
